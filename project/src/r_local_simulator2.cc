...
#include "src/stop.h"
#include "src/route.h"
#include "src/r_local_simulator2.h"
...
bool rLocalSimulator2::Start() {
  ...
  Stop * stop_CC_EB_6 = new Stop(2, 44.983375, -93.178810);  // Fairgrounds
  Stop * stop_CC_EB_7 = new Stop(3, 44.984540, -93.181692);  // Buford & Gartner
  Stop * stop_CC_EB_8 = new Stop(4, 44.984630, -93.186352);  // SPSC
