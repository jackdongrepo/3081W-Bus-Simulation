...
bool rLocalSimulator::Start() {
  ...
  CC_EB_probs.push_back(.00);  // SPSC - MUST BE 0
  ...
  CC_WB_probs.push_back(.10);  // Jones-Eddy
  CC_WB_probs.push_back(.30);  // Bruininks
  CC_WB_probs.push_back(.00);  // Blegen
